...
KenobiSoft.metafields.map = KenobiSoft.metafields.map || function ($component) {
    ...
    $valWrapper = $component.find('textarea'), $latCtrl = $controls.find('input.lat'), $lngCtrl = $controls.find('input.lng'), $zoomCtrl = $controls.find('input.zoom'), lat = $component.data('lat'), lng = $component.data('lng'), zoom = $component.data('zoom'), mapStyle = [];
