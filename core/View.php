...
class View {
    ...
    /**
     * @property InitialzrCollection $collection
     */
    ...
    public function __construct($config) {
        ...
        $this->collection = new Collection(self::$config['module']['collection']);
    }
    ...
    protected function loadHeader() {
        ...
        $url        = $this->getUrl();
        $pages      = $this->getData('page', self::$config['pages']);
        ?>
        ...
        <div class="view-heading">
            ...
            <div class="view-title">
                <p><?php echo __(self::$config['module']['name']); ?></p>
            </div>
            <!-- /title -->
                        ...
                        <?php foreach ($pages as $index => $page) : ?>
                            <li class="nav-element<?php echo $page_index == $index ? ' active' : ''; ?>">
                                <div class="view-nav-element">
                                    <a href="<?php echo $url . '&' . self::$config['module']['params']['page'] . '=' . $index; ?>" class="view-button-nav" data-index="<?php echo $index; ?>"><?php echo ucfirst($page['name']); ?></a>
                                </div>
                            </li>
                        <?php endforeach; ?>
                    </ul>
        ...
        <div class="view-main" id="initialzr-main-wrapper">
            ...
            <div class="view-page" data-view-page="<?php echo $this->getCurrentPage(); ?>">
                ...
                <form class="view-form" action="" method="POST">
                    ...
                    <?php settings_fields(self::$config['module']['collection']['optionName']); ?>
    ...
    protected function getPageIndex() {
        $pageParam = self::$config['module']['params']['page'];
    ...
    public function clearUrlParams($url) {
        ...
        // Strip module params
        $url = preg_replace('/' . self::$config['module']['params']['page'] . '=\d+/', '', $url, 1);

        // Strip update param
        $url = preg_replace('/' . self::$config['module']['params']['update'] . '=[a-z]+/', '', $url, 1);
